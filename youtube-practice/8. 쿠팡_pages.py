...
for index in range(1, 6):
    print(f'################### {index} page #####################')
    url = f'https://www.coupang.com/np/search?q=헤드폰&channel=user&component=&eventCategory=SRP&trcid=&traid=&sorter=scoreDesc&minPrice=&maxPrice=&priceRange=&filterType=&listSize=36&filter=&isPriceRange=false&brand=&offerCondition=&rating=0&page={index}&rocketAll=false&searchIndexingToken=1=6&backgroundColor='
